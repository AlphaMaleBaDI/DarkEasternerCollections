    ...
    >
      <Link href={`/${category}`} className="absolute inset-0 z-20">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-6 z-20">
          <p className="text-luxury-gold text-[10px] uppercase tracking-[0.4em] mb-4 transition-all duration-500 group-hover:tracking-[0.5em]">
            {config.label}
          </p>
          <h3 className="text-4xl md:text-6xl lg:text-7xl font-serif italic text-white mb-6 opacity-90">
            {config.heroCopy}
          </h3>
          <div className="w-12 h-px bg-luxury-gold transition-all duration-500 group-hover:w-24" />

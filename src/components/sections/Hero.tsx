    ...
    <section className="relative min-h-[80vh] lg:min-h-screen flex items-center overflow-hidden bg-deep-black pt-16 lg:pt-0">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-0 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-start lg:pr-12 order-2 lg:order-1">
            <motion.div
            ...
            >
              <div>
                ...
                <h1 className="text-4xl md:text-6xl lg:text-8xl font-heading leading-[1] lg:leading-[0.95] tracking-tight">
                  Confidence <br /> 
                  <span className="italic pl-4 md:pl-8">Tailored</span> <br />
                  to <span className="text-luxury-gold">Presence</span>.
                </h1>
              </div>

              <p className="text-soft-white/50 text-lg md:text-xl max-w-sm leading-relaxed font-light">
